...
//        Box box = new Box(9);
//        Box b = new Box(9,18,39);
//        Box box1 = box;// Direct reference
//        Box box2 = new Box(box1);// only value copy no refer to same object
//        // box2 and box1 have different add location
//        Box box3 = new Box(b);
//
//        box.displayInfo();
